    ...
    <div class="row">
      ...
      <form action="game-submit.php" method="post">
        ...
        <div class="small-6 columns red-team">
          <h3>Red</h3>
          <select name="red-player-1" id="red-player-1" class="player-select">
          ...
          <select name="red-player-2" id="red-player-2" class="player-select">
            <option value="">Select red player</option>
            <?php
              foreach($players as $key => $player) {
                echo '<option value="' . $player['player_id'] . '">' . $player['name'] . '</option>' . "\n";
        ...
        <div class="small-6 columns blue-team">
          <h3>Blue</h3>
          <select name="blue-player-1" id="blue-player-1" class="player-select">
          ...
          <select name="blue-player-2" id="blue-player-2" class="player-select">
            <option value="">Select blue player</option>
            <?php
              foreach($players as $key => $player) {
                echo '<option value="' . $player['player_id'] . '">' . $player['name'] . '</option>' . "\n";
      ...
      <div class="row">
        ...
        <div class="small-12 columns">
          ...
          <input type="submit" id="submit-button" class="button expand" value="Submit game">
        </div>
